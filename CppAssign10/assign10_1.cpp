...
//     int choice;
//     cout << "\n*****************************MENU*****************************\n";
//     cout << "\n 0.EXIT \t 1.ACCEPT\t 2.DEPOSIT \t 3.WITHDRAW \t 4.DISPLAY FWD ORDER \t 5.DISPLAY REV ORDER ";
//     cout << "\nEnter your choice : ";
//     cin >> choice;
...
//     vector<account *> accList; // vector to store account objects
...
//             cin >> depAmt;
//             accList.at(index - 1)->deposit(depAmt);
//             // for (int i = 0; i < accList.size(); i++)
//             accList.at(index - 1)->display();
//             break;
//         case 3:
...
//             try
//             {
//                 accList.at(index - 1)->withdraw(withdrawAmt);
//             }
...
//             break;
//         case 4:
//             cout << "\n************************** Accounts in forward order ************************** " << endl;
//             for (int i = 0; i < accList.size(); i++)
...
//             cout << "\n************************** Accounts in reverse order ************************** " << endl;
//             /* Iterate vector in reverse order */
//             for (vector<account *>::reverse_iterator it = accList.rbegin(); it != accList.rend(); ++it)
//             {
//                 (*it)->display();
//             }
//             break;
...
//         cout << "Enter amount to deposit : ";
//         cin >> depAmt;
//         accList[index - 1].deposit(depAmt);
//         for (int i = 0; i < accList.size(); i++)
//             accList.at(i).display();
//         break;
//     case 3:
...
//         try
//         {
//             accList[index - 1].withdraw(withdrawAmt);
//         }
//         catch (insuff_funds ins_funds)
//         {
//             ins_funds.display();
